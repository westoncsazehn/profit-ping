  ...
  <>
    <Container>
      <Box component={StyledPaper} sx={MIN_BOX_PAGE}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Brainfish LLC.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Profit Ping, accessible from{' '}
              <a
                href="https://profitping.app"
                rel="external nofollow noopener"
                target="_blank">
                https://profitping.app
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: admin@brainfish.io</li>
        </ul>
      </Box>
    </Container>
  </>
